...
public class RedisReplyTracker implements ReplyTracker {

    @Value("${replyTracker.redis.channel}")
    String channel;
    @Value("${replyTracker.redis.key-prefix}")
    String keyPrefix;
    @Value("${replyTracker.redis.default-ttl-millis:30000}")
